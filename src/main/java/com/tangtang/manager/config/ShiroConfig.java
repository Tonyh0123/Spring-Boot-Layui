...
import com.tangtang.manager.filter.KickoutSessionFilter;
import com.tangtang.manager.shiro.MyRealm;
...
public class ShiroConfig {
     ...
     * </br>1,配置shiro安全管理器接口securityManager;
